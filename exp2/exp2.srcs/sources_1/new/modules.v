...
module nandgate(
    ...
    assign out = ~(input1 & input2);
    //get the and of the inputs and negate the result, assign the reuslt to output
endmodule
module nandgate_3(
    input  input1,//first input
    input  input2,//second input
    input  input3,//third input
    output  out//output
    );
    assign out = ~(input1 & input2 & input3);
    //get and of the 3 inputs and negate the result, assign to output
endmodule
...
//input
    ...
    assign out = ~input1;
    //get negation of the input assign it to output
endmodule
